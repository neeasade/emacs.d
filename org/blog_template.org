...
# #+html_head: <style> body { background-color: #767676 !important; } </style>
...
#+MACRO: spoiler @@html:<span class=spoiler>$1</span>@@
...
<h1 class=title>
    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <rect x="5" y="15" width="20" height="20" fill="#e9a4d1" stroke="#e9a4d1" stroke-width="4"/>
        <rect x="14" y="6" width="20" height="20" fill="#86c2d7" stroke="#86c2d7" stroke-width="4"/>
    </svg>
    {{page-title}}
    <svg viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg">
        <rect x="14" y="6" width="20" height="20" fill="#7bcc7b" stroke="#7bcc7b" stroke-width="4"/>
        <rect x="5" y="15" width="20" height="20" fill="#98bde1" stroke="#98bde1" stroke-width="4"/>
    </svg>
</h1>
#+end_export
...
# yes .meta-container is actually used -- todo better name
#+BEGIN_EXPORT html
{{#include-pubdate}}
{{#published-date}}
...
{{/published-date}}
<span class="posttags"> {{taghtml}} </span>
</div>
{{/include-pubdate}}
</header>
#+end_export
...
{{#is-index}}
    ...
    <a href='https://recurse.com'><img alt='Recurse Center Logo' src='./assets/img/logos/recurse.png' style='height:40px;width:40px;'></a>
{{/is-index}}
{{#is-post}}
<footer>
    <div style="float: left">
