...
(add-transient-hook! 'doom-init-modules-hook
  (setq avy-keys '(?a ?r ?s ?t ?g ?k ?n ?e ?i ?o)
    lispy-avy-keys '(?a ?r ?s ?t ?g ?k ?n ?e ?i ?o))

  ;; :ui window-select settings, ignoring +numbers flag for now
  (after! ace-window
    (setq aw-keys '(?a ?r ?s ?t ?g ?k ?n ?e ?i ?o)))
  (after! switch-window
    (setq switch-window-shortcut-style 'qwerty
      switch-window-qwerty-shortcuts '("a" "r" "s" "t" "g" "k" "n" "e" "i" "o")))
...
(when (featurep! :editor evil)
  (add-transient-hook! 'doom-init-modules-hook
    ...
    (setq evil-markdown-movement-bindings '((up . "e")
                                             (down . "n")
                                             (left . "h")
                                             (right . "l"))
      evil-org-movement-bindings '((up . "e")
                                    (down . "n")
                                    (left . "h")
                                    (right . "l")))
